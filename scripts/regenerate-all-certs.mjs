...
.hdr-meta { width: 70px; text-align: right; flex-shrink: 0; }
.hdr-meta-label {
...
const FOOTER = `
  <div class="gen-notice">
    <span style="font-size:8pt;opacity:.6">🔒</span>
  ...
  <div class="ftr">
    ...
    <div class="ftr-inner">
      <div class="sig-area">
        <div style="position:relative;height:70px;margin-bottom:4px;width:100%">
          <div style="position:absolute;left:0;bottom:5px;z-index:2">
            <img src="{signature}" onerror="this.style.display='none'" alt="Signature" style="max-height:55px;max-width:100px;object-fit:contain;display:block">
          </div>
          <div style="position:absolute;left:80px;bottom:0px;z-index:1;opacity:.85">
            <img src="{stamp}" onerror="this.style.display='none'" alt="Stamp" style="max-height:70px;max-width:100px;object-fit:contain;display:block">
          </div>
        </div>
